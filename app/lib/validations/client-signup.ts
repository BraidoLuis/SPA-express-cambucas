...
export function validateClientSignup(data: ClientSignupData): SignupErrors {
  ...
  if (normalizeBrazilianPhone(data.phone).length !== 11) {
    errors.phone = "Informe um celular com DDD e 11 dígitos.";
  }
  ...
  if (
    ...
    errors.password = "Use 8 caracteres, com maiúscula, minúscula e número.";
  }
