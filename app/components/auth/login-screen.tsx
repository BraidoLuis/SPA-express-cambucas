...
export function LoginScreen({
  ...
  async function savePassword(event: React.FormEvent) {
    ...
    try {
      ...
      setError("O link expirou ou é inválido. Solicite uma nova recuperação.");
    } finally {
      setSubmitting(false);
    }
  }
    ...
    <div className={`login-screen ${admin ? "admin-access" : "client-access"}`}>
      ...
      <div className="login-brand">
        <img
          ...
          alt={admin ? "Equipe do SPA Express Cambucás" : "Profissional do SPA Express Cambucás"}
        />

        <div className="login-overlay" />

        <button className="button-with-icon" onClick={close}>
        ...
        <div className="login-quote">
          <span>✦</span>
          <p>
            {admin ? "Organização para cuidar ainda melhor." : "Você merece um tempo só seu."}
          </p>
        </div>
      </div>
      ...
      <div className="login-side">
        <div className="mobile-login-hero">
          ...
          <div>
            <span>✦</span>
            <p>
              {admin ? "Seu espaço de trabalho, do seu jeito." : "Você merece um momento só seu."}
            </p>
          </div>
        </div>
        ...
        <form className="login-box" onSubmit={recovering ? savePassword : submit}>
          ...
          <label>{recovering ? "Nova senha" : "Senha"}</label>
          <div className="login-input">
            <span>⌑</span>
            <input
