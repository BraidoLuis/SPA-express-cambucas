...
const initialData: ClientSignupData = {
  fullName: "",
  phone: "",
  email: "",
  password: "",
...
export function SignUpForm({
  ...
  const update = <K extends keyof ClientSignupData>(
    field: K,
    value: ClientSignupData[K],
  ) => {
    ...
    <div className="signup-overlay">
      ...
      <div className="signup-panel">
        <form className="signup-card" onSubmit={submit} noValidate>
          ...
          <p>
            Os dados abaixo também serão usados para enviar confirmações
            seguras de agendamento.
          </p>

          <div className="signup-grid">
            <label>
              Nome completo
              <div className={`login-input ${errors.fullName ? "invalid" : ""}`}>
                <span>♡</span>
                <input
                  autoComplete="name"
                  value={form.fullName}
          ...
          <div className="signup-preferences">
            <h3>Confirmações de agendamento</h3>
            <label>
              <input
                type="checkbox"
            ...
            <label>
              ...
              <span>
                ...
                <small>
                  Seus dados serão utilizados para criar sua conta, realizar
                  agendamentos e enviar informações relacionadas aos atendimentos.
                </small>
              </span>
            </label>
            {errors.privacyAccepted && (
              <small className="field-error">{errors.privacyAccepted}</small>
            )}
          </div>
